...
public class SortTester {
    ...
    public static void main(String[] args) {
        ...
        // Random Array
        int[] abc=makeRandomArray(arraySize);
        int[] abcd=makeAlmostSortedArray(arraySize);
        int[] abcde=makeReverseArray(arraySize);
        // Make array
        

        startTime=System.currentTimeMillis();
        
        Sorter.mergeSort(abc,arraySize);
        
        System.out.println("Random Array: "+(System.currentTimeMillis()-startTime));
        

        startTime=System.currentTimeMillis();
        
        Sorter.mergeSort(abcd,arraySize);
        
        System.out.println("Almost Sorted Array: "+(System.currentTimeMillis()-startTime));
        

        startTime=System.currentTimeMillis();
        
        Sorter.mergeSort(abcde,arraySize);
        
        System.out.println("Reverse Array: "+(System.currentTimeMillis()-startTime));
